...
<html lang="en">
  ...
  <div class="container">
    ...
    <div class="container bg-light" style="margin-top:80px; width:50%; padding:20px">
      <form class="container" action="../admin-livreur/php_file/modifier_profil.php" method="POST">
          ...
          <div class="container">
            <div class="form-row" >
              ...
              <label>sexe</label>
                <input type="texte" name="sexe" class="form-control"value="<?=$sexe ?>">
              </div>
            </div>
            ...
            <div class="form-row" style="margin-top:10px" >
              ...
              <label>Etat de santé</label>
                <input type="text" name="allergies_traitements" class="form-control"value="<?=$allergies_traitements?>">
              </div>
            </div>
            <div class="form-row" style="margin-top:10px" >
              <div class="col">
                <label>Date naissance</label>
                <input type="date" name="date_naissance" class="form-control" value="<?=$date_naissance?>">
              </div>
              <div class="col">
              
              <label>Img</label>
                <input type="photo" name="photo_att" class="form-control"value="<?=$photo_att ?>">
              </div>
