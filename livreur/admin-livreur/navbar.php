  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item active">
        <a class="nav-link" href="index_livreur.php"> <i class="fa fa-home"></i> Accueil <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
    ...
    <div class="form-inline my-2 my-lg-0">
        <a class="nav-link" href="deconn_livreur.php"> <i class="fa fa-sign-out"></i> Deconnexion</a>
    </div>
  </div>
</nav>
...
<nav class="navbar fixed-bottom navbar-light bg-info">
    <h5>
       <i class="fa fa-user-circle-o"></i> Connecté en tant que  <?php echo $_SESSION['email_livreur'] ?> 
    </h5>
    ...
    <div class="form-inline my-2 my-lg-0">
       ...
       $email_livreur = $_SESSION['email_livreur'];
        ...
        extract($id);
            echo "
                <a class='nav-link' href='modifier_profil.php?id_livreur=$id_livreur'> <i class='fa fa-sign-out'></i> Modifier votre profil</a>           
            ";
        ?>
    </div>
</nav>
