<?php
session_start();
if(isset($_SESSION['email_client'])){//Si la variable0. session a ŽtŽ crŽee
            ...
            <hr class="my-5">
                    ...
                    <div class="media position-relative">
                        ...
                        <div class="media-body">
                            <h5 class="mt-0">PANEL</h5>
                            <p>Vous accederez à un espace spécialement dédié à vos actions </p>
                            
                            <div class="input-group col-lg-4 mb-4" style="margin-left: 300px">
                            <a href="../client/admin-client/index_client.php" class="stretched-link">Basculer</a>
                           </div>
                     ...
                     <div  class="input-group col-lg-2 mb-4" style="margin-left: 375px">
                        <a href="../client/php_files/deconn_client.php" class="btn btn-primary btn-block py-2">
...
<?php 
    ...
    echo 'connectez-vous
    <a href="../client/connexion_client.php" class="btn btn-primary btn-block py-2">
